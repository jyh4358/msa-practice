...
| **인가 얕음**(payment 공개 노출·IDOR·서비스 신원 없음) | payment 노출·IDOR: ✅ **감사(2026-08-02)에서 폐쇄**([AUDIT-2026-08.md](AUDIT-2026-08.md)) · 서비스 신원: → [BACKLOG.md](BACKLOG.md) |
| **단일 호스트**(스케일·셀프힐 없음), 이미지 수동 | **Phase 16**(k8s)·**17**(CI/CD) |
| 시크릿 키 관리 단순(dev 키) | → [BACKLOG.md](BACKLOG.md) |
